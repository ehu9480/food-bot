...
BOT_TOKEN = "MTIwNDE5Nzc2MTY4ODUzOTE5Ng.G6OF2m.Txg0DOBDfb4FdKVx5j4QVB8dHpy3u-FhKf0P70"
...
@bot.event
async def on_ready():
    scheduler.add_job(send_daily_message, CronTrigger(hour=17, minute=30, timezone=pytz.timezone('US/Eastern')))
    scheduler.start()
